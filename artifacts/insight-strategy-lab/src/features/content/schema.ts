...
export const SOLUTIONS_GROUP: ContentGroup = {
  ...
  fields: [
    ...
    { key: "ttb_slides_heading", section: "Screenshot Slideshow", label: "Section heading", type: "text", default: "See the System in Action", help: "Leave empty to hide the slideshow section." },
    { key: "ttb_slide_1_image", section: "Screenshot Slideshow", label: "Slide 1 — image", type: "image", default: "", help: "Upload or paste a screenshot URL. The slideshow is hidden until at least one image is added." },
    { key: "ttb_slide_1_caption", section: "Screenshot Slideshow", label: "Slide 1 — caption", type: "text", default: "" },
    { key: "ttb_slide_2_image", section: "Screenshot Slideshow", label: "Slide 2 — image", type: "image", default: "" },
    { key: "ttb_slide_2_caption", section: "Screenshot Slideshow", label: "Slide 2 — caption", type: "text", default: "" },
    { key: "ttb_slide_3_image", section: "Screenshot Slideshow", label: "Slide 3 — image", type: "image", default: "" },
    { key: "ttb_slide_3_caption", section: "Screenshot Slideshow", label: "Slide 3 — caption", type: "text", default: "" },
    { key: "ttb_slide_4_image", section: "Screenshot Slideshow", label: "Slide 4 — image", type: "image", default: "" },
    { key: "ttb_slide_4_caption", section: "Screenshot Slideshow", label: "Slide 4 — caption", type: "text", default: "" },
    { key: "ttb_slide_5_image", section: "Screenshot Slideshow", label: "Slide 5 — image", type: "image", default: "" },
    { key: "ttb_slide_5_caption", section: "Screenshot Slideshow", label: "Slide 5 — caption", type: "text", default: "" },
    { key: "ttb_slide_6_image", section: "Screenshot Slideshow", label: "Slide 6 — image", type: "image", default: "" },
    { key: "ttb_slide_6_caption", section: "Screenshot Slideshow", label: "Slide 6 — caption", type: "text", default: "" },
    { key: "ttb_slide_7_image", section: "Screenshot Slideshow", label: "Slide 7 — image", type: "image", default: "" },
    { key: "ttb_slide_7_caption", section: "Screenshot Slideshow", label: "Slide 7 — caption", type: "text", default: "" },
    { key: "ttb_slide_8_image", section: "Screenshot Slideshow", label: "Slide 8 — image", type: "image", default: "" },
    { key: "ttb_slide_8_caption", section: "Screenshot Slideshow", label: "Slide 8 — caption", type: "text", default: "" },
    // ── Download ──
