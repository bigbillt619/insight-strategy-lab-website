...
export const ABOUT_GROUP: ContentGroup = {
  ...
  fields: [
    ...
    { key: "hero_title", label: "Page title", type: "text", default: "The Architect Behind the Business Operating System" },
    { key: "photo", label: "Founder photo", type: "image", default: "", help: "Optional. Shows at the top of the page when set." },
    { key: "lead", label: "Lead paragraph", type: "textarea", default: "I help small businesses, nonprofits, and mission-driven organizations integrate People, Processes, Technology, Data, and AI into one Business Operating System.\n\nMy work focuses on reducing complexity, improving visibility, and creating the operational foundation organizations need to scale sustainably.\n\nAfter more than 27 years leading teams and solving complex organizational challenges, I\u2019ve learned that most organizations don\u2019t fail because people aren\u2019t working hard \u2014 they struggle because their systems aren\u2019t working together.\n\nInsight Strategy Lab exists to solve that problem.", help: "Leave a blank line between paragraphs to create separate paragraphs." },
    { key: "body", label: "Leadership foundation paragraph", type: "textarea", default: "Before founding Insight Strategy Lab, I served for 27 years on active duty in the United States Marine Corps, retiring as a Lieutenant Colonel.\n\nThroughout that career, I led complex organizations, managed large-scale operations, and learned firsthand that successful execution depends on systems, accountability, and alignment.\n\nThose same principles now guide every engagement at Insight Strategy Lab.", help: "Leave a blank line between paragraphs to create separate paragraphs. This section appears below the hero." },
    ...
    { key: "philosophy_body", label: "Philosophy - body", type: "textarea", default: "Many organizations already know where they want to go.\n\nThe challenge is that information is scattered, processes are inconsistent, technology is disconnected, and leaders lack the visibility needed to execute effectively.\n\nMy approach is simple: systems should reduce complexity, not create it.\n\nEvery Business Operating System is designed to improve clarity, accountability, efficiency, and growth by integrating the five pillars of organizational performance:", help: "Leave a blank line between paragraphs to create separate paragraphs." },
    { key: "philosophy_pillars", label: "Philosophy - five pillars list", type: "list", default: "People\nProcesses\nTechnology\nData\nAI", help: "Rendered as a bullet list after the philosophy body. Leave empty to hide." },
    { key: "creds_heading", label: "Education - heading", type: "text", default: "Education" },
    { key: "creds_intro", label: "Education - intro", type: "textarea", default: "My formal education spans business, leadership, analytics, organizational systems, and strategic planning \u2014 a multidisciplinary background that informs the Business Operating System framework used in every client engagement.", help: "Optional context line above the credentials list." },
    { key: "creds", label: "Education list", type: "list", default: "Bachelor of Business Administration in Human Resource Management (Minor in Economics)\nMaster of Science in Management\nMaster of Arts in Military Studies\nMaster of Business Administration" },
...
export const DIAGNOSTIC_GROUP: ContentGroup = {
  ...
  fields: [
    ...
    { key: "scorecard_label", label: "Scorecard - label", type: "text", default: "ISL Business Operating System Score" },
    { key: "overall_score_label", label: "Scorecard - overall score label", type: "text", default: "Overall BOS Score" },
    { key: "level_prefix", label: "Scorecard - maturity level prefix", type: "text", default: "Your BOS Maturity Level:", help: "Shown before the maturity level name (Foundational, Operational, etc.)." },
