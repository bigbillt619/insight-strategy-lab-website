...
export const HOME_GROUP: ContentGroup = {
  ...
  fields: [
    ...
    { key: "hero_cta_2", section: "Hero", label: "Secondary CTA button", type: "text", default: "Take the BOS Assessment" },
    { key: "hero_cta_2_href", section: "Hero", label: "Secondary CTA destination", type: "url", default: "/diagnostic", help: "Where the secondary hero button links. Default is the BOS Assessment." },
    ...
    { key: "faq_4_q", section: "FAQ", label: "FAQ 4 — question", type: "text", default: "Does a Business Operating System include AI?" },
    { key: "faq_4_a", section: "FAQ", label: "FAQ 4 — answer", type: "textarea", default: "Yes — AI is the fifth pillar of the BOS framework, alongside People, Processes, Technology, and Data. We identify practical AI opportunities, select appropriate tools, and integrate them into your operating system so AI works with your existing workflows rather than adding complexity on top of them." },
...
export const SERVICES_GROUP: ContentGroup = {
  ...
  fields: [
    { key: "seo_title", label: "SEO page title", type: "text", default: "Business Operating System Design & Implementation | Insight Strategy Lab", help: "Shown in browser tab and Google search results (~50–60 chars ideal)." },
...
export const SOLUTIONS_GROUP: ContentGroup = {
  ...
  fields: [
    ...
    // ── PDF Preview ──
    { key: "ttb_slides_heading", section: "PDF Preview", label: "Section heading", type: "text", default: "See the System in Action", help: "Leave empty to hide the PDF preview section." },
    // ── Download ──
    ...
    // ── Living 2 Live (l2l_) ──────────────────────────────────────────
    // SEO
    { key: "l2l_seo_title", section: "L2L SEO", label: "SEO — page title", type: "text", default: "Living 2 Live Operations Hub | Organizational Operating System Transformation" },
    { key: "l2l_seo_description", section: "L2L SEO", label: "SEO — meta description", type: "textarea", default: "See how Living 2 Live transformed founder-led operations into an integrated organizational operating system that aligns people, programs, fundraising, community engagement, governance, and insights." },
    // Featured card (on Solutions page)
    { key: "l2l_card_subtitle", section: "L2L Featured Card", label: "Card subtitle", type: "text", default: "Organizational Operating System Transformation" },
    { key: "l2l_card_description", section: "L2L Featured Card", label: "Card description", type: "textarea", default: "Transforming founder-led operations into an integrated organizational operating system that aligns people, programs, fundraising, community engagement, governance, and insights." },
    { key: "l2l_cta_primary", section: "L2L Featured Card", label: "Primary CTA button", type: "text", default: "View Transformation Story" },
    { key: "l2l_cta_secondary", section: "L2L Featured Card", label: "Secondary CTA button", type: "text", default: "Launch Interactive Demo" },
    { key: "l2l_demo_url", section: "L2L Featured Card", label: "Demo link URL", type: "url", default: "", help: "Where the 'Launch Interactive Demo' button links." },
    // Hero
    { key: "l2l_hero_badge", section: "L2L Hero", label: "Hero badge", type: "text", default: "Transformation Story" },
    { key: "l2l_hero_title", section: "L2L Hero", label: "Hero title", type: "text", default: "Living 2 Live Operations Hub" },
    { key: "l2l_hero_subtitle", section: "L2L Hero", label: "Hero subtitle", type: "text", default: "From Founder-Led Operations to an Integrated Organizational Operating System" },
    { key: "l2l_hero_body", section: "L2L Hero", label: "Hero supporting text", type: "textarea", default: "The Living 2 Live Operations Hub demonstrates how Insight Strategy Lab designs and implements Business Operating Systems that integrate people, programs, fundraising, community engagement, operations, governance, and insights into a unified operational framework." },
    { key: "l2l_hero_cta_primary", section: "L2L Hero", label: "Primary CTA button", type: "text", default: "View Interactive Demo" },
    { key: "l2l_hero_cta_primary_url", section: "L2L Hero", label: "Primary CTA destination", type: "url", default: "", help: "Where the primary hero button links (e.g. demo URL)." },
    { key: "l2l_hero_cta_secondary", section: "L2L Hero", label: "Secondary CTA button", type: "text", default: "Watch Transformation Story" },
    { key: "l2l_hero_cta_secondary_url", section: "L2L Hero", label: "Secondary CTA destination", type: "url", default: "#video", help: "Anchor (#video) scrolls to the video section. Or enter a YouTube URL." },
    // Credibility Banner
    { key: "l2l_cred_heading", section: "L2L Credibility Banner", label: "Banner status label", type: "text", default: "Phase 1 Status: Complete", help: "Leave empty to hide the banner." },
    { key: "l2l_cred_stat_1_value", section: "L2L Credibility Banner", label: "Stat 1 — value", type: "text", default: "23" },
    { key: "l2l_cred_stat_1_label", section: "L2L Credibility Banner", label: "Stat 1 — label", type: "text", default: "Clients Managed" },
    { key: "l2l_cred_stat_2_value", section: "L2L Credibility Banner", label: "Stat 2 — value", type: "text", default: "153" },
    { key: "l2l_cred_stat_2_label", section: "L2L Credibility Banner", label: "Stat 2 — label", type: "text", default: "Activities Logged" },
    { key: "l2l_cred_stat_3_value", section: "L2L Credibility Banner", label: "Stat 3 — value", type: "text", default: "79" },
    { key: "l2l_cred_stat_3_label", section: "L2L Credibility Banner", label: "Stat 3 — label", type: "text", default: "Webhooks Processed" },
    { key: "l2l_cred_stat_4_value", section: "L2L Credibility Banner", label: "Stat 4 — value", type: "text", default: "0" },
    { key: "l2l_cred_stat_4_label", section: "L2L Credibility Banner", label: "Stat 4 — label", type: "text", default: "Open Failures" },
    // Challenge
    { key: "l2l_challenge_heading", section: "L2L Challenge", label: "Section heading", type: "text", default: "Growth Was Being Limited by Operational Complexity" },
    { key: "l2l_challenge_body", section: "L2L Challenge", label: "Section body", type: "textarea", default: "Living 2 Live is a nonprofit organization serving youth and families through programs, community engagement, fundraising, and governance. Growth was creating operational complexity across all departments — without a unified system to manage people, programs, data, and decisions." },
    { key: "l2l_challenge_items", section: "L2L Challenge", label: "Challenge items", type: "list", default: "Founder-Led Operations\nManual Processes\nDisconnected Systems\nOperational Complexity\nLimited Visibility\nGovernance Gaps", help: "One item per line." },
    // Transformation Strategy (BOS pillars)
    { key: "l2l_approach_heading", section: "L2L Transformation Strategy", label: "Section heading", type: "text", default: "Building a Business Operating System" },
    { key: "l2l_approach_body", section: "L2L Transformation Strategy", label: "Section intro", type: "textarea", default: "The system was designed around the five pillars of the Business Operating System framework — integrating every dimension of organizational performance into a single operational model." },
    { key: "l2l_pillar_people_label", section: "L2L Transformation Strategy", label: "Pillar — People label", type: "text", default: "People" },
    { key: "l2l_pillar_people_desc", section: "L2L Transformation Strategy", label: "Pillar — People description", type: "textarea", default: "Designed around the staff, coaches, volunteers, and clients who deliver and experience the mission." },
    { key: "l2l_pillar_process_label", section: "L2L Transformation Strategy", label: "Pillar — Process label", type: "text", default: "Processes" },
    { key: "l2l_pillar_process_desc", section: "L2L Transformation Strategy", label: "Pillar — Process description", type: "textarea", default: "Standardized intake, program delivery, fundraising, and governance workflows that run consistently across the organization." },
    { key: "l2l_pillar_technology_label", section: "L2L Transformation Strategy", label: "Pillar — Technology label", type: "text", default: "Technology" },
    { key: "l2l_pillar_technology_desc", section: "L2L Transformation Strategy", label: "Pillar — Technology description", type: "textarea", default: "An integrated platform replacing disconnected tools with one unified system spanning all operational domains." },
    { key: "l2l_pillar_data_label", section: "L2L Transformation Strategy", label: "Pillar — Data label", type: "text", default: "Data" },
    { key: "l2l_pillar_data_desc", section: "L2L Transformation Strategy", label: "Pillar — Data description", type: "textarea", default: "Centralized records across clients, programs, fundraising, and operations — visible in real time to leadership." },
    { key: "l2l_pillar_ai_label", section: "L2L Transformation Strategy", label: "Pillar — AI label", type: "text", default: "AI" },
    { key: "l2l_pillar_ai_desc", section: "L2L Transformation Strategy", label: "Pillar — AI description", type: "textarea", default: "Intelligent automation and insights that reduce manual work and surface patterns across programs, fundraising, and community engagement." },
    { key: "l2l_support_attrs", section: "L2L Transformation Strategy", label: "Supporting attributes", type: "list", default: "Governed\nIntegrated\nVisible\nRepeatable\nScalable", help: "One attribute per line. Displayed as badges below the pillars." },
    // Operating System hub
    { key: "l2l_os_heading", section: "L2L Operating System", label: "Section heading", type: "text", default: "The Living 2 Live Operating System", help: "Leave empty to hide this section." },
    { key: "l2l_os_hub_label", section: "L2L Operating System", label: "Hub center label", type: "text", default: "Insights" },
    { key: "l2l_os_spoke_items", section: "L2L Operating System", label: "Spoke items (6 max)", type: "list", default: "People\nPrograms\nCommunity\nFundraising\nOperations\nGovernance", help: "One item per line. Up to 6 items displayed around the hub." },
    { key: "l2l_os_body", section: "L2L Operating System", label: "Supporting text", type: "textarea", default: "A single source of truth supporting mission delivery, fundraising, governance, operations, and organizational growth." },
    // Results — Operational Metrics
    { key: "l2l_results_heading", section: "L2L Results", label: "Section heading", type: "text", default: "Measurable Operational Impact", help: "Leave empty to hide results. Uses metric grid (not the list format)." },
    { key: "l2l_results_stat_1_value", section: "L2L Results", label: "Stat 1 — value", type: "text", default: "23" },
    { key: "l2l_results_stat_1_label", section: "L2L Results", label: "Stat 1 — label", type: "text", default: "Client Records" },
    { key: "l2l_results_stat_2_value", section: "L2L Results", label: "Stat 2 — value", type: "text", default: "153" },
    { key: "l2l_results_stat_2_label", section: "L2L Results", label: "Stat 2 — label", type: "text", default: "Community Activities" },
    { key: "l2l_results_stat_3_value", section: "L2L Results", label: "Stat 3 — value", type: "text", default: "10" },
    { key: "l2l_results_stat_3_label", section: "L2L Results", label: "Stat 3 — label", type: "text", default: "Donations Captured" },
    { key: "l2l_results_stat_4_value", section: "L2L Results", label: "Stat 4 — value", type: "text", default: "2" },
    { key: "l2l_results_stat_4_label", section: "L2L Results", label: "Stat 4 — label", type: "text", default: "Monthly Giving Subscriptions" },
    { key: "l2l_results_stat_5_value", section: "L2L Results", label: "Stat 5 — value", type: "text", default: "79" },
    { key: "l2l_results_stat_5_label", section: "L2L Results", label: "Stat 5 — label", type: "text", default: "Square Webhook Events" },
    { key: "l2l_results_stat_6_value", section: "L2L Results", label: "Stat 6 — value", type: "text", default: "0" },
    { key: "l2l_results_stat_6_label", section: "L2L Results", label: "Stat 6 — label", type: "text", default: "Open Webhook Failures" },
    // Results — Platform Foundation
    { key: "l2l_platform_heading", section: "L2L Results", label: "Platform Foundation sub-heading", type: "text", default: "Platform Foundation", help: "Leave empty to hide the platform sub-section." },
    { key: "l2l_platform_stat_1_value", section: "L2L Results", label: "Platform stat 1 — value", type: "text", default: "35" },
    { key: "l2l_platform_stat_1_label", section: "L2L Results", label: "Platform stat 1 — label", type: "text", default: "Database Migrations" },
    { key: "l2l_platform_stat_2_value", section: "L2L Results", label: "Platform stat 2 — value", type: "text", default: "37" },
    { key: "l2l_platform_stat_2_label", section: "L2L Results", label: "Platform stat 2 — label", type: "text", default: "Frontend Pages" },
    { key: "l2l_platform_stat_3_value", section: "L2L Results", label: "Platform stat 3 — value", type: "text", default: "35+" },
    { key: "l2l_platform_stat_3_label", section: "L2L Results", label: "Platform stat 3 — label", type: "text", default: "Administrative Workflows" },
    // Strategic Impact
    { key: "l2l_impact_heading", section: "L2L Strategic Impact", label: "Section heading", type: "text", default: "Transformation Beyond Technology", help: "Leave empty to hide this section." },
    { key: "l2l_impact_items", section: "L2L Strategic Impact", label: "Impact cards", type: "list", default: "Operational Efficiency\nRisk Reduction\nAutomation\nScalability\nGovernance Maturity\nData Visibility", help: "One item per line. Up to 6 cards." },
    // Video
    { key: "l2l_video_heading", section: "L2L Video", label: "Section heading", type: "text", default: "Watch the Transformation Story", help: "Leave empty to hide the video section." },
    { key: "l2l_video_url", section: "L2L Video", label: "YouTube video URL", type: "url", default: "", help: "Paste the YouTube video URL." },
    { key: "l2l_video_body", section: "L2L Video", label: "Supporting text", type: "textarea", default: "Explore how Living 2 Live transformed founder-led operations into a scalable organizational operating system." },
    // Interactive Demo
    { key: "l2l_demo_heading", section: "L2L Interactive Demo", label: "Section heading", type: "text", default: "Explore the Business Operating System", help: "Leave empty to hide the demo section." },
    { key: "l2l_demo_callout", section: "L2L Interactive Demo", label: "Strategic callout text", type: "textarea", default: "More than a CRM. More than an App.\n\nAn integrated operational framework connecting people, programs, fundraising, community engagement, operations, governance, and insights." },
    { key: "l2l_demo_body", section: "L2L Interactive Demo", label: "Description", type: "textarea", default: "Explore a fully fictional demonstration environment showcasing how people, programs, fundraising, community engagement, operations, governance, and insights work together in a unified operational framework." },
    { key: "l2l_demo_cta", section: "L2L Interactive Demo", label: "Demo CTA button", type: "text", default: "Launch Interactive Demo" },
    { key: "l2l_demo_destination", section: "L2L Interactive Demo", label: "Demo destination URL", type: "url", default: "", help: "Where the demo button links." },
    // Transformation Resources
    { key: "l2l_resources_heading", section: "L2L Transformation Resources", label: "Section heading", type: "text", default: "Explore the Transformation", help: "Leave empty to hide the resources section." },
    { key: "l2l_resource_1_label", section: "L2L Transformation Resources", label: "Resource 1 — label", type: "text", default: "Operations Transformation Story" },
    { key: "l2l_resource_1_url", section: "L2L Transformation Resources", label: "Resource 1 — PDF", type: "file", default: "", help: "Upload a PDF or paste a direct URL." },
    { key: "l2l_resource_2_label", section: "L2L Transformation Resources", label: "Resource 2 — label", type: "text", default: "Phase 1 Blueprint" },
    { key: "l2l_resource_2_url", section: "L2L Transformation Resources", label: "Resource 2 — PDF", type: "file", default: "" },
    { key: "l2l_resource_3_label", section: "L2L Transformation Resources", label: "Resource 3 — label (optional)", type: "text", default: "Phase 1 Closeout Report" },
    { key: "l2l_resource_3_url", section: "L2L Transformation Resources", label: "Resource 3 — PDF (optional)", type: "file", default: "" },
    // Roadmap
    { key: "l2l_roadmap_heading", section: "L2L Roadmap", label: "Section heading", type: "text", default: "The Foundation for Future Growth", help: "Leave empty to hide the roadmap section." },
    { key: "l2l_roadmap_phase_1_label", section: "L2L Roadmap", label: "Phase 1 — name", type: "text", default: "Foundation & Intake" },
    { key: "l2l_roadmap_phase_1_status", section: "L2L Roadmap", label: "Phase 1 — status", type: "text", default: "Complete" },
    { key: "l2l_roadmap_phase_2_label", section: "L2L Roadmap", label: "Phase 2 — name", type: "text", default: "Multi-Coach Delivery" },
    { key: "l2l_roadmap_phase_2_status", section: "L2L Roadmap", label: "Phase 2 — status", type: "text", default: "Ready" },
    { key: "l2l_roadmap_phase_3_label", section: "L2L Roadmap", label: "Phase 3 — name", type: "text", default: "Curriculum Centralization" },
    { key: "l2l_roadmap_phase_3_status", section: "L2L Roadmap", label: "Phase 3 — status", type: "text", default: "Planned" },
    { key: "l2l_roadmap_phase_4_label", section: "L2L Roadmap", label: "Phase 4 — name", type: "text", default: "Workflow Automation" },
    { key: "l2l_roadmap_phase_4_status", section: "L2L Roadmap", label: "Phase 4 — status", type: "text", default: "Planned" },
    { key: "l2l_roadmap_phase_5_label", section: "L2L Roadmap", label: "Phase 5 — name", type: "text", default: "Fundraising & Impact" },
    { key: "l2l_roadmap_phase_5_status", section: "L2L Roadmap", label: "Phase 5 — status", type: "text", default: "Planned" },
    { key: "l2l_roadmap_phase_6_label", section: "L2L Roadmap", label: "Phase 6 — name", type: "text", default: "Leadership & Governance" },
    { key: "l2l_roadmap_phase_6_status", section: "L2L Roadmap", label: "Phase 6 — status", type: "text", default: "Planned" },
    // Bottom CTA
    { key: "l2l_cta_heading", section: "L2L Bottom CTA", label: "CTA heading", type: "text", default: "Building Systems That Empower Mission-Driven Organizations" },
    { key: "l2l_cta_body", section: "L2L Bottom CTA", label: "CTA body", type: "textarea", default: "Living 2 Live demonstrates how Business Operating Systems can integrate people, processes, technology, data, and AI into a unified operational framework.\n\nThis was not a software project.\n\nIt was an organizational transformation." },
    { key: "l2l_cta_button", section: "L2L Bottom CTA", label: "CTA button", type: "text", default: "Schedule a Business Operating System Review" },
  ],
};
